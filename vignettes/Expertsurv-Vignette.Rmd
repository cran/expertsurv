...
```{r echo = FALSE, fig.cap = "Expert prior distributions", out.width="75%"}
...
```
```{r echo = FALSE, fig.cap = "Model Comparison", out.width="75%"}
knitr::include_graphics("plots/Vignette_Example_1_DIC.png")
```

```{r echo = FALSE, fig.cap = "Survival function with Expert prior", out.width="75%"}
...
```{r echo = FALSE, fig.cap = "Survival function with Expert prior (left) and Vague prior (right)", out.width="75%"}
...
```{r echo = FALSE, fig.cap = "Survival difference", out.width="75%"}
