...
namespace {
  ...
  template <
    ...
    typename Function>
  inline
  expertsurv::Mapply_4<RTYPE_1,NA_1,T_1,RTYPE_2,NA_2,T_2,RTYPE_3,NA_3,T_3,RTYPE_4,NA_4,T_4,Function>
  mapply(
    ...
    return expertsurv::Mapply_4<RTYPE_1,NA_1,T_1,RTYPE_2,NA_2,T_2,RTYPE_3,NA_3,T_3,RTYPE_4,NA_4,T_4,Function>( t1, t2, t3, t4, fun ) ;
  }
